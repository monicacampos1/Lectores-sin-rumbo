    ...
    public partial class agregarprestamos : Form
    {
        ...
        private void bguardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                myCommand.Parameters.Add("?nombrelip", MySqlDbType.VarChar, 50).Value = txtlibro.Text;
                myCommand.Parameters.Add("?idlibrop", MySqlDbType.Int32, 11).Value = txtidli.Text;
                myCommand.Parameters.Add("?fentregap", MySqlDbType.VarChar, 15).Value = txtfecha.Text;
                myCommand.Parameters.Add("?fdevolucionp", MySqlDbType.VarChar, 15).Value = txtdevo.Text;
                myCommand.Parameters.Add("?idempleadop", MySqlDbType.VarChar, 15).Value = txtempleado.Text;
                myCommand.Parameters.Add("?obsevacionesp", MySqlDbType.VarChar, 150).Value = txtobser.Text;
